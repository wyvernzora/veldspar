...
Veldspar.Transforms = { 
  ...
  jsonTransform : function (obj, rules) {
    ...
    for (n in rules) {
      ...
      } else if (typeof rules[n] === 'function') {
...
Veldspar.Transforms.Character = {
  ...
  walletBalance: {
    ...
    "accounts": function (o) {
      ...
      _.each(raw, function (a) { accounts.push(Veldspar.Transforms.jsonTransform(a, Veldspar.Transforms.Character.account)); });
      return accounts;
    }
  }
